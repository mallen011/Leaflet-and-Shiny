...
FP$popup <- paste("<p><h2>", FP$name,"</p></h2>",
                  ...
                  "<h3>Snap benefits?</h3> ", FP$snap,"<br />",
...
GS$popup <- paste("<p><h2>", GS$name,"</p></h2>",
                  ...
                  "<h3>Snap benefits? </h3>", GS$snap,"<br />",
...
FM$popup <- paste("<p><h2>", FM$name,"</p></h2>",
                  ...
                  "<h3>Snap benefits?</h3> ", FM$snap,"<br />",
...
###################### Output map EKY_Resources #########################
   groups <- c("<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/farmstand.png' height='40' width='40'> Farmer Markets", 
               "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/supermarket.png' height='40' width='40'>Grocery Stores", 
               "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/office-building.png' height='40' width='40'>Cooperative Extension Offices",
               "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/communitycentre.png' height='40' width='40'>Social Services", 
               "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/library.png' height='40' width='40'>Libraries",
               "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/recycle.png' height='40' width='40'>Recycling Centers")
    ...
    leaflet() %>% 
      ...
      addMarkers(data = FM,
                 ...
                 icon = FM_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/farmstand.png' height='40' width='40'> Farmer Markets",
      ...
      addMarkers(data = EO,
                 ...
                 icon = EO_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/office-building.png' height='40' width='40'>Cooperative Extension Offices",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
      ...
      addMarkers(data = SS,
                 ...
                 icon = SS_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/communitycentre.png' height='40' width='40'>Social Services",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
      ...
      addMarkers(data = LIB,
                 ...
                 icon = LIB_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/library.png' height='40' width='40'>Libraries",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
      ...
      addMarkers(data = GS,
                 ...
                 icon = GS_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/supermarket.png' height='40' width='40'>Grocery Stores",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
    ...
    addMarkers(data = RE,
                 ...
                 icon = RE_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/recycle.png' height='40' width='40'>Recycling Centers",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
   ...
   output$map2 <- renderLeaflet({
    leaflet() %>% 
      ...
      addMarkers(data = FP,
                 ...
                 icon = FP_icon,
                 group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/conveniencestore.png' height='40' width='40'>All stores & markets selling fresh produce",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = FP_snap,
                  ...
                  group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/fruits.png' height='40' width='40'>Stores & markets accepting SNAP/EBT benefits",
                  icon = FP_snap_icon,
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                             return new L.DivIcon({
       ...
       addMarkers(data = FP_wic,
                  ...
                  group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/grocery.png' height='40' width='40'>Stores & markets accepting WIC benefits",
                  icon = FP_wic_icon,
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
       ...
       addMarkers(data = FP_fm_senior,
                  ...
                  group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/farmstand.png' height='40' width='40'>Farmers' markets accepting senior vouchers",
      ...
      addLayersControl("bottomright", baseGroups = c("Esri.WorldImagery", "Toner"),
                       overlayGroups = c("<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/conveniencestore.png' height='40' width='40'>All stores & markets selling fresh produce",
                                         "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/fruits.png' height='40' width='40'>Stores & markets accepting SNAP/EBT benefits",
                                         "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/grocery.png' height='40' width='40'>Stores & markets accepting WIC benefits",
                                         "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/farmstand.png' height='40' width='40'>Farmers' markets accepting senior vouchers"
                                        ),
                      options = layersControlOptions(collapsed = FALSE)
                ) 
})
...
######### map3 output ############ 
      ...
      addLayersControl("bottomright", baseGroups = c("Esri.WorldImagery", "Toner"), 
                       overlayGroups = c("<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/recycle.png' height='40' width='40'>Recycling centers"),
                       options = layersControlOptions(collapsed = FALSE))
   ...
   output$map4 <- renderLeaflet({
    leaflet() %>% 
      ...
      addMarkers(data = SS,
                 ...
                 popup = lapply(SS$popup, HTML),
                 icon = SS_icon,
                 group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/communitycentre.png' height='40' width='40'>All social services",
                 clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = SS_families,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/family.png' height='40' width='40'>Family Services",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = SS_community,
                  ...
                  group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/group-2.png' height='40' width='40'>Community Services",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = SS_careers,
                  ...
                  group = "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/findajob.png' height='40' width='40'>Career Services",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
      ...
      addLayersControl("bottomright", baseGroups = c("Esri.WorldImagery", "Toner"),
                       overlayGroups = c("<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/communitycentre.png' height='40' width='40'>All social services",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/family.png' height='40' width='40'>Family Services",
                                         "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/group-2.png' height='40' width='40'>Community Services",
                                         "<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/findajob.png' height='40' width='40'>Career Services"), 
                                          options = layersControlOptions(collapsed = FALSE))
  })
   ...
   output$map6 <- renderLeaflet({
     leaflet() %>% 
       ...
       addMarkers(data = LIB,
                  ...
                  popup = lapply(LIB$popup, HTML),
                  icon = LIB_icon,
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/library.png' height='40' width='40'>All libraries",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                         function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_bookmobile,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/truck3.png' height='40' width='40'>Bookmobile and public outreach services",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_free_wifi,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/wi-fi-2.png' height='40' width='40'>Free Wifi",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_com_access,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/computers.png' height='40' width='40'>Open computer access",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_meeting_rooms,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/glazer.png' height='40' width='40'>Meeting rooms available",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_e_audio,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/audio.png' height='40' width='40'>Ebooks and audio books available",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addMarkers(data = LIB_test_prep,
                  ...
                  group = "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/test-2.png' height='40' width='40'>Test preparation resources",
                  clusterOptions = markerClusterOptions(iconCreateFunction = JS("
                                          function(cluster) {
                                          return new L.DivIcon({
                                               html: '<div style=\"background-color:rgba(77,77,77,0.5)\"><span>' + cluster.getChildCount() + '</div><span>',
       ...
       addLayersControl("bottomright", baseGroups = c("Esri.WorldImagery", "Toner"),
                        overlayGroups =c("<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/library.png' height='40' width='40'>All libraries",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/truck3.png' height='40' width='40'>Bookmobile and public outreach services",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/wi-fi-2.png' height='40' width='40'>Free Wifi",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/computers.png' height='40' width='40'>Open computer access",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/glazer.png' height='40' width='40'>Meeting rooms available",
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/audio.png' height='40' width='40'>Ebooks and audio books available", 
                                         "<img src= 'https://experiential-binder.000webhostapp.com/EKY_Resources/test-2.png' height='40' width='40'>Test preparation resources"),
                        options = layersControlOptions(collapsed = FALSE))
   })  
