...
###### SET PATH HERE #####
#path <- "C:/Users/user_name/Desktop/GIS/Shiny Leaflet Map"
#setwd(path)
...
counties$popup <- paste0("<p><h2>", counties$CNTY_NAME," County", "</p></h2>")
...
all_counties <- readOGR("polygons/tl_2016_21_cousub.shp")
...
tabItem(tabName = "EKY_Resources",
      ...
      absolutePanel(id = "controls1", class = "panel panel-default", fixed = FALSE, top = 60, left = "auto", right = 22, bottom = "auto", height = "auto",
...
tabItem(tabName = "fresh_produce",
        ...
        leafletOutput("map2", height = 680),
        
        absolutePanel(id = "controls2", fixed = FALSE, top = 60, left = "auto", right = 22, bottom = "auto", height = "auto",
...
tabItem(tabName = "recycling_centers",
    ...
    leafletOutput("map3", height = 680),

    absolutePanel(id = "controls3", fixed = FALSE, top = 60, left = "auto", right = 22, bottom = "auto", height = "auto",
...
tabItem(tabName = "social_services",
     ...
     leafletOutput("map4", height = 680),

     absolutePanel(id = "controls4", fixed = FALSE, top = 60, left = "auto", right = 22, bottom = "auto",
                   height = "auto",
...
tabItem(tabName = "libraries",
      ...
      leafletOutput("map6", height = 680),

      absolutePanel(id = "controls5", fixed = FALSE, top = 60, left = "auto", right = 22, bottom = "auto",
                    height = "auto",
...
###################### Output map EKY_Resources #########################
   groups <- c("<img src='https://experiential-binder.000webhostapp.com/EKY_Resources/farmstand.png'> Farmer Markets", 
    ...
    leaflet() %>% 
      ...
      addProviderTiles(providers$Stamen.Toner, group = "Base Map") %>% 
      addProviderTiles("Esri.WorldImagery", group = "Satellite Map") %>% 
      addPolygons(data = counties,
                  color = "#339966",
                  weight = 2,
                  label = lapply(counties$popup,HTML),
    ...
    addLayersControl("bottomright", baseGroups = c("Base Map",
                                                   "Satellite Map"
                                                   ),
...
###################### Output map2 - Fresh Produce #########################
   ...
   output$map2 <- renderLeaflet({
    leaflet() %>% 
      ...
      addLayersControl("bottomright", baseGroups = c("Base Map", "Satellite Map"),
